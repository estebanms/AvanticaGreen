...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :standings, 'Standings', root_path, :if => Proc.new { can?(:read, Team) }
    primary.item :infractions, 'Infractions', infractions_path, :if => Proc.new { can?(:read, Infraction) }
    primary.item :players, 'Players', players_path, :if => Proc.new { can?(:read, Player) }
